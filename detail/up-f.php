...
<div class="container">
    ...
    <div class="filter" style="margin-top:10px;">
        ...
        <a class="d-btn first-filter" href="#1">1단지 F타입 2세대</a>
        <a class="d-btn" href="#2">4단지 F타입 2세대</a>
    </div>
    <div class="gallery">
        <div class="large-12 columns">
            <a href="#" class="1"><img src="img/unitplan/1-f-2.jpg"></a>
            <a href="#" class="2"><img src="img/unitplan/4-f-2.jpg"></a>
        </div>
    </div>
    <script>
